		...
		<div class='footer_txt'>
			<div class='container'>
				...
				<?php /* 
					...
					You can buy this theme without footer links online at http://smthemes.com/buy/sunnybeach/
				*/ ?>
				<div class='smthemes'>Designed by <a href='http://disneycruise.org/' target='_blank'>Disney Cruises</a>, thanks to: <a href='http://www.artifyworldblog.com/' target='_blank'>Der ArtifyWorld-Blog von Arno G. Richter</a>, <a href='http://jdis.co/' target='_blank'>JDis.co</a> and <a href='http://sjthemes.com/' target='_blank'>SJThemes.com</a></div>
			</div>
		</div>
		<?php wp_footer(); ?>
