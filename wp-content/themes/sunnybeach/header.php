...
<div id='background'>
	<div class='white-bgr container'></div>
	<img class='left-cloud' src='<?php echo get_template_directory_uri(); ?>/images/left-cloud.jpg'>
	<img class='right-cloud' src='<?php echo get_template_directory_uri(); ?>/images/right-cloud.jpg'>
	<img class='middle-cloud' src='<?php echo get_template_directory_uri(); ?>/images/middle-cloud.png'>
</div>
